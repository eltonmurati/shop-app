...
export default async function SuccessPage({searchParams}:{searchParams:any}) {
  ...
  return (
    <div id="payment-status">
      <div id="status-icon" style={{backgroundColor: STATUS_CONTENT_MAP[status as keyof typeof STATUS_CONTENT_MAP].iconColor}}>
      ...
      {paymentIntent && <a href={`https://dashboard.stripe.com/payments/${paymentIntentId}`} id="view-details" target="_blank">View details
