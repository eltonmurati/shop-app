...
const ContactPage = () => {
    return(
        <div className="px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 md:pt-8 pb-16 min-h-max h-[calc(100vh-80px)] xl:h-[calc(100vh-144px)] flex items-center flex-col md:flex-row gap-8 xl:gap-16">
