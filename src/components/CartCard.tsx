                        ...
                        <div className="flex justify-between gap-8 text-sm">
                            <div className="flex gap-1">
                                {!verified && <div className="flex items-center">
                                    <button className="text-gray-400 transition-colors duration-200 hover:text-blue-700 w-4 h-4 flex items-center justify-center" onClick={removeOne}>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-3">
                                            <path d="M3.75 7.25a.75.75 0 0 0 0 1.5h8.5a.75.75 0 0 0 0-1.5h-8.5Z" />
                                        </svg>
                                    </button>
                                    <button className="text-gray-400 transition-colors duration-200 hover:text-blue-700 w-4 h-4 flex items-center justify-center" onClick={addOne}>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="size-3">
                            ...
                            {!verified && <button className="text-red-200 hover:text-red-500 transition-colors duration-200" onClick={deleteCard}>Remove</button>}
                        </div>
                    </div>
                </Link>
            )}
