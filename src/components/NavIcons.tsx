...
const NavIcons = () => {
    ...
    return (
        <div className="flex items-center gap-4 xl:gap-6 relative">
            <button className="hover:text-blue-700 transition-colors linear duration-200">
            ...
            <button className="relative hover:text-blue-700 transition-colors linear duration-200" onClick={()=>setIsCartOpen((prev) => !prev)}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
