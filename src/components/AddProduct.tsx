...
const AddProduct = ({open, onClose}:{open:boolean; onClose:()=>void;}) => {
    ...
    return(
        <div className={"absolute top-0 left-0 h-full w-full p-4 flex justify-center items-center bg-[rgb(0_0_0_/_var(--tw-bg-opacity,0.1))] " + (fadeout ? "opacity-0 animate-[fadeout_200ms_linear]" : "animate-[fadein_200ms_linear]")}>
                    ...
                    <div className="flex flex-wrap gap-8 max-h-full overflow-auto">
                        ...
                        <div className="flex gap-8 w-full max-w-[20rem]">
                            <div className="flex flex-col gap-2">
                                ...
                                <input type="checkbox" name="sale" className="h-14 accent-blue-700 cursor-pointer"/>
                            </div>
