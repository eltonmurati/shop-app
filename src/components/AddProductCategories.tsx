    ...
    return(
        <div className="flex flex-col gap-2 w-full max-w-[20rem]">
            <div className="flex gap-2">
                ...
                {categories.length > 1 && (
                    <button type="button" className="text-sm text-red-200 flex gap-1 items-center hover:text-red-500 transition-colors linear duration-200" onClick={()=>setCategories([])}>
                ...
                <div className="flex flex-col gap-2 max-h-[5.5rem] overflow-y-auto">
                    {categories.map((category)=>(
                        <div key={category} className="flex gap-1">
                            ...
                            <button type="button" className="text-gray-400 hover:text-red-500" onClick={()=>removeCategory(category)}>
