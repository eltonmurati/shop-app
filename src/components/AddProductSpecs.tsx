    ...
    return(
        <div className="flex flex-col gap-2 sm:w-[calc(50%-1rem)] lg:w-[calc(33.33%-1.3334rem)] w-full">
            ...
            <div className="flex gap-2">
                ...
                {specs.length > 3 && (
                    <button type="button" className="text-red-200 flex gap-1 items-center hover:text-red-500 transition-colors linear duration-200" onClick={()=>{setSpecs([]); setFinal(undefined); updateSpecs(undefined);}}>
