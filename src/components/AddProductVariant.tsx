    ...
    return(
        <div className="rounded-lg flex flex-col gap-2">
            <div className="flex gap-1 justify-between">
                <input required type="text" name={"varname"+id} placeholder="Type" className="text-sm h-6 w-full ring-2 ring-inset ring-gray-300 rounded-md px-2 outline-none"></input>
