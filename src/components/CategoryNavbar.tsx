...
const CategoryNavbar = () => {
    ...
    return (
        <div className="relative" onMouseLeave={()=>setTabId(0)}>
            {/* BIGGER SCREENS */}
            <div className="hidden xl:flex h-16 bg-bwcblue font-semibold text-white">
                ...
                <Link href="/" className="w-full h-full px-1 flex items-center justify-center text-center leading-tight hover:bg-white hover:text-bwcblue" onMouseEnter={()=>setTabId(0)}>Clearance</Link>
            </div>
