...
const Slider = () => {
    ...
    return (
        <div className="h-[calc(100vh-80px)] xl:h-[calc(100vh-144px)] overflow-hidden">
            ...
            <div className="absolute m-auto left-1/2 bottom-8 flex transform -translate-x-1/2 gap-4">
