            ...
            {stock > 0 ? (
                <div className="flex justify-between">
                    ...
                    <div className="relative">
                        <button 
                            className="absolute right-0 w-36 text-sm rounded-3xl ring-1 ring-blue-700 bg-white text-blue-700 py-3 px-4 hover:bg-blue-700 hover:text-white 
                        ...
                        <div className={"absolute right-4 text-sm flex gap-1.5 text-green-500 z-00 w-max transition-all duration-500 " + (added ? "-top-7 ease-out" : "top-3 ease-in")}>
